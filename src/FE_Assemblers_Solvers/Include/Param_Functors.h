...
// Specialization for constant case (ad hoc functions are needed)
template<>
...
public:
  ...
  // Compute diffusion angle from K
...
public:
  ...
  // Get first component of advection
  Real get_b1_coeff(void) const
  { 
    return b_ptr_[0];
  }

  // Get second component of advection  
