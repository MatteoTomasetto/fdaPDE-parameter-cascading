...
public:
    ///
    /// The number of corrections to approximate the inverse Hessian MatrixXr.
    /// The L-BFGS routine stores the computation results of previous \ref m
    /// iterations to approximate the inverse Hessian MatrixXr of the current
...
public:
    ...
    /// An error will be thrown if some parameter
    /// is invalid.
    ///
