...
class Lambda_optimizer
{
        ...
        public: //GETTERS
        		inline InputCarrier const & get_carrier(void) const {return this -> the_carrier;};
...
class GCV_Family: Lambda_optimizer<InputCarrier, size>
{
        ...
        virtual Real compute_f(lambda::type<size> lambda) = 0;       //!< Main function, represents the gcv computation
                ...
                // GETTERS
                inline VectorXr & const get_z_hat(void) const { return this -> z_hat;};
                inline Uint & const get_s(void) const { return this -> s;};
